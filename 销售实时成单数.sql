...
from(        
        ...
        left join (
                    select a.department_name,
                           ...
                           count(case when month(a.max_pay_date) = month(curdate()) then a.contract_id else null end) as tomonth_order,
                           sum(case when month(a.max_pay_date) = month(curdate()) then a.contract_amount else 0 end) as tomonth_amount,
