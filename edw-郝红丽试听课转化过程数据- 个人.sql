...
from(    
        select
				   lpo.apply_user_id, cdme.name, cdme.job_number, cdme.department_name, lpo.student_intention_id, s.student_no,
	    ...
	    left join (
						...
						group by tc.contract_id, tc.student_intention_id, tc.submit_user_id
...
group by b.apply_user_id, b.name, b.job_number, b.department_name